...
// Función para limpiar directorio con manejo de errores mejorado
...
const connectDB = async () => {
    try {
        ...
        console.log('✅ Intentando conectar a MongoDB para la exportación (TypeScript Compatible)...');
...
const exportData = async () => {
    try {
        ...
        console.log(`📊 Se encontraron ${policies.length} pólizas para exportar.`);
        ...
        for (const policy of policies) {
            try {
                ...
                console.error(`❌ Error al procesar póliza ${policy.numeroPoliza}:`, err);
                errorCount++;
            }
        }
