...
// Conecta a la DB con conexión directa compatible con TypeScript
async function connectDB() {
    try {
        ...
        console.log('✅ Conectando a MongoDB para exportación streaming (TypeScript Compatible)...');
...
// Exportación con streaming y manejo de errores mejorado
async function exportExcelStream() {
    try {
        ...
        console.log('🔄 Iniciando procesamiento streaming de pólizas...');
        ...
        for (let doc = await cursor.next(); doc != null; doc = await cursor.next()) {
            try {
                ...
                console.error(`❌ Error al procesar póliza ${doc.numeroPoliza || 'sin número'}:`, err);
                errorCount++;
            }
        }
        ...
        console.log(`📊 Pólizas procesadas: ${processedCount}`);
        console.log(`⚠️ Errores durante procesamiento: ${errorCount}`);
        console.log('🎯 Versión: TypeScript Compatible con Streaming');
