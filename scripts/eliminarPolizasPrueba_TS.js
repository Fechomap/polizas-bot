...
// Compatible con migración TypeScript
// Pólizas: 12345, 123456, 1, 2, 3, 4, 5, 6
// Este script es específico para limpiar el entorno de pruebas BD AUTOS
require('dotenv').config();
const mongoose = require('mongoose');

// Pólizas de prueba comunes
const POLIZAS_PRUEBA = ['1', '2', '3', '4', '5', '6', '12345', '123456'];
...
async function eliminarPolizasPrueba() {
    try {
        ...
        for (const numeroPoliza of POLIZAS_PRUEBA) {
            ...
            console.log(`   - Serie vehículo: ${policy.serie || 'No definida'}`);
...
// Ejecutar
console.log('🧹 SCRIPT DE LIMPIEZA PARA PÓLIZAS DE PRUEBA BD AUTOS (TypeScript Compatible)');
console.log('═════════════════════════════════════════════════════════════════════════════');
console.log('📋 Pólizas a eliminar: 1, 2, 3, 4, 5, 6, 12345, 123456');
