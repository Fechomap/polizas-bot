...
const connectDB = async () => {
    try {
        ...
        console.log('✅ Intentando conectar a MongoDB (TypeScript compatible)...');
...
const deletePolicy = async () => {
    try {
        ...
        console.log('\n🔄 Herramienta para eliminación PERMANENTE de pólizas (TypeScript Compatible)');
        console.log(
