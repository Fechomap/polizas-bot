...
describe('Admin Module Integration', () => {
    test('El módulo AdminModule se puede importar', () => {
        ...
        const adminModulePath = '../../src/admin/index.ts';
        expect(() => {
    ...
    test('Los archivos del módulo admin existen', () => {
        const adminFiles = [
            ...
            'menus/adminMenu.ts',
            'menus/menuBuilder.ts',
            'handlers/policyHandler.ts',
            'handlers/serviceHandler.ts',
            'handlers/databaseHandler.ts',
            'utils/adminStates.ts',
